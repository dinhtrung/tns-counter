...
var DocumentSnapshot = /** @class */ (function (_super) {
    ...
    function DocumentSnapshot(snapshot) {
        var _this = _super.call(this, snapshot ? snapshot.getId() : null, snapshot.exists(), firebase_common_1.firebase.toJsObject(snapshot.getData())) || this;
                ...
                var getDynamicLinksCallback = new com.google.android.gms.tasks.OnCompleteListener({
                    onComplete: function (task) {
                        if (task.isSuccessful() && task.getResult() !== null) {
                            var result_1 = task.getResult();
                            if (firebase_common_1.firebase._dynamicLinkCallback === null) {
                                firebase_common_1.firebase._cachedDynamicLink = {
                                    url: result_1.getLink().toString(),
                                    // matchConfidence: 1,
                                    minimumAppVersion: result_1.getMinimumAppVersion()
                                };
                            }
                            else {
                                setTimeout(function () {
